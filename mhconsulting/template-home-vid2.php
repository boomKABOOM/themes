<?php /* Template Name: Home Vid2 Template */ get_header(); ?>
...
<div class="wrapper w-intro bg-white">
  <video id="home_bg_vid" class="full-only" muted="" autoplay="" loop="">
    <source id="mp4" type="video/mp4" src="<?php echo $themeRoot; ?>images/vid-2.mp4">
  </video>
    <div class="row">
      <div class="col-12 textcenter p-5">
        <img src="<?php echo $themeRoot; ?>images/logo-full.png" /><br/>
