...
<div class="wrapper img-header dark" style="background:linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(<?php echo get_template_directory_uri().'/images/img-main1.jpg'; ?>) left no-repeat; background-size:cover;">
