...
$(window).load(function(){
  if (getUrlParameter('language') == 'es') {
    $('body').addClass('translate-es');
    $.cookie("translate-es", 1,{
      expires: 20*365
    });
  }
  if (getUrlParameter('language') == 'en') {
    $('body').removeClass('translate-es');
    $.removeCookie("translate-es", 1);
  }
  if($.cookie("translate-es")){
    console.log("spanish translation" );
  } else {
    console.log("do not translate english");
  }
});
