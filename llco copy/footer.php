<?php $themeRoot = "/wp-content/themes/llco/"; ?>
      ...
      <div class="row">
        <div class="col-6 col-sm-3 p-3">
          ...
          <div class="social-links">
            <a href="https://www.facebook.com/RobinetPhysicalTherapy/" target="_blank"><i class="icons8-facebook"></i></a>
            <a href="https://www.instagram.com/robinetpt/" target="_blank"><i class="icons8-instagram-filled"></i></a>
            <a href="https://www.yelp.com/biz/robinet-physical-therapy-rockford" target="_blank"><i class="icons8-yelp-filled"></i></a>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-sm-6 text-center text-sm-left">
          &copy; 2018 Robinet Physical Therapy
        </div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-96714915-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-96714915-1');
</script>
